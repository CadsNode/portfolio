...
const resumeContent = [
...

  {
    ...
    timeDuraton: `Full Time`,
    compnayName: "WBBV",
    jobDescription: ` Was involved in building and maintaining marketing and ecommerce site for the company. Built
    systems with Nextjs, Nodejs/express, MySQL, MongoDB, GraphQL, and various APIs such as MapQuest, VRM valuation. 
    Sites were a success and established additional revenue for the company, helping to sell their products by over 90%.
    `,
    delayAnimation: "300",
  },

  {
    ...
    jobType: `Remote`,
    jobDuration: `Sep 2018 - Nov 2020`,
    timeDuraton: `Full Time`,
    compnayName: "CadsNode.",
    jobDescription: ` Built an online educational platform to teach users 
    Machine Learning and Web Development. Frontend was built with React and 
    backend with NodeJs and Express. Used MYSQL and MONGODB as databases to 
    capture user data and build lessons. Used AWS S3 for cloud storage of videos and images 
    & Firebase for login and user authentication.  
    `,
    delayAnimation: "400",
  },
...
const educatonContent = [
  {
    ...
    degreeTitle: "Ph.D in Electrical Engineering",
    instituteName: "University Of Cape Town",
  },
  {
    passingYear: "2010-2011",
    degreeTitle: "Msc. in Communication Network Planning and Management",
    instituteName: "University of Portsmouth",
  },
  {
    passingYear: "2007-2008",
    degreeTitle: "Msc. in Communication Engineering",
    instituteName: "University of Manchester",
  },
  {
    passingYear: "2000-2005",
    degreeTitle: "Bsc. in Electrical and Computer Engineering",
    instituteName: "The Ohio State University",
  },
];
